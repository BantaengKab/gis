...
<template>
    <LayoutAuthenticated>
        <Head title="View Investasi" />
        <SectionMain>
            <SectionTitleLineWithButton
                :icon="mdiFinance"
                title="View Investasi"
                main
            >
                <BaseButton
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td
                                class="p-4 pl-8 text-slate-500 dark:text-slate-400 hidden lg:block"
                            >
                                Tanggal Di Rencanakan
                            </td>
                            <td data-label="Tglrencana">
                                {{
                                    moment(investasi.tgl_rencana).format(
                                        "DD/MM/YYYY"
                                    )
                                }}
                            </td>
                        ...
                        <tr>
                            <td
                                class="p-4 pl-8 text-slate-500 dark:text-slate-400 hidden lg:block"
                            >
                                Tanggal Di Realisasikan
                            </td>
                            <td data-label="Tglrealisasi">
                                {{
                                    moment(investasi.tgl_realisasi).format(
                                        "DD/MM/YYYY"
                                    )
                                }}
                            </td>
