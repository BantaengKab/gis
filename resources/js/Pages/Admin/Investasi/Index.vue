          ...
          <thead>
            <tr>
              <th>
               ...
               <th>
                <Sort label="Rencana(Rp.)" attribute="rencana" />
              </th>
               <th>
                <Sort label="Realisasi(Rp.)" attribute="realisasi" />
              </th>
          ...
          <tbody>
            <tr v-for="investasi in investasis.data" :key="investasi.id">
              <td data-label="Investor">
                <Link
                  :href="route('investor.show', investasi.investor_id)"
                  class="
                    no-underline
                    hover:underline
                    text-cyan-600
              ...
              <td data-label="Rencana">
                <Link
                  :href="route('investasi.show', investasi.id)"
                  class="
                    no-underline
                    hover:underline
                    text-cyan-600
              ...
              >
                <BaseButtons type="justify-start lg:justify-end" no-wrap>
                  <BaseButton
                    v-if="can.edit"
                    :route-name="route('investasi.edit', investasi.id)"
                    color="info"
