...
<template>
  <LayoutAuthenticated>
    ...
    <SectionMain>
      ...
      <CardBox
        form
        @submit.prevent="form.post(route('investasi.update', props.investasi.id))"
      >
       ...
       <FormControl
            ...
            :options="investor"
          >
            <div class="text-red-400 text-sm" v-if="form.errors.investor_id">
        ...
        >
          ...
          >
            <div class="text-red-400 text-sm" v-if="form.errors.rencana">
              {{ form.errors.rencana }}
            </div>
          </FormControl>
        </FormField>
        ...
        >
          ...
          >
            <div class="text-red-400 text-sm" v-if="form.errors.realisasi">
        ...
        >
          ...
          >
            <div class="text-red-400 text-sm" v-if="form.errors.tgl_rencana">
        ...
        >
          ...
          >
            <div class="text-red-400 text-sm" v-if="form.errors.tgl_realisasi">
